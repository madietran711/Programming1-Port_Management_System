...
public class User implements Serializable {
    ...
    public void login(String enteredUsername, String enteredPassword)
            throws IncorrectPasswordException, AccountNotFoundException {
        if (this.username.equals(enteredUsername)) {
            if (checkLogin(enteredUsername, enteredPassword)) {
                ...
                throw new IncorrectPasswordException(
                        "Incorrect password entered. (" + loginAttempts + "/" + MAX_LOGIN_ATTEMPTS + ")");
            }
        } else {
    ...
    public static void main(String[] args) {
        SystemAdmin admin1 = new SystemAdmin("01", "admin1", "password1");
